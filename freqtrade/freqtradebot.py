...
class FreqtradeBot(LoggingMixin):
    ...
    def check_unknown_trades(self, pair_whitelist) -> None:
        ...
        for pair, is_short in product(pair_whitelist, [False, True]):
            side = "short" if is_short else "long"
            pos = positions.get(pair+"_" + side)
            if pos is None:
                continue
    ...
    def execute_entry(
        ...
        *,
        ...
        order = self.exchange.create_order(
            ...
            time_in_force=time_in_force,
            leverage=leverage,
            position_side = position_side,    # 新增支持双向持仓
        )
        ...
        *,
        ...
        try:
            ...
            order = self.exchange.create_order(
                ...
                time_in_force=time_in_force,
                position_side=position_side,      # 新增双向持仓
            )
        except InsufficientFundsError as e:
